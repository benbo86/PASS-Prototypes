// Copied verbatim from Icons/Cellular Connection.svg, Icons/Wifi.svg and
// Icons/Battery.svg (fill/stroke swapped to currentColor for theming) —
// real iOS status-bar glyphs, replacing the earlier hand-drawn
// approximations (rolled out from the openPASS Push Notifications
// prototype's own lock screen, which needed accurate status-bar icons for
// its OS-chrome mockup — this shared component picked up the same fix so
// every mobile/* prototype gets it too, not just that one page). Named
// exports so openpass/push-notifications' own lock screen (which needs
// these same three icons individually, not wrapped in .status-bar) can
// import them directly instead of keeping its own duplicate copies.
