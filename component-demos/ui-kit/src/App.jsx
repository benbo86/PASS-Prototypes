...
export default function App() {
  ...
  return (
    <>
      ...
      <Section title="Search multi-select" description="Components/SearchMultiSelect.jsx — type to filter a list, click a result to add it, added items render as removable rows. Mirrors the search-to-add UX originally built for roster-settings/settings' own (since-removed) Contactable employees feature, rather than react-select's chip-multiselect. First built for 'Preferred care workers'.">
