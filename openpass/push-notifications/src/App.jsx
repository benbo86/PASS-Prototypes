      ...
      <div className="opn-lock-statusbar">
        ...
        <div className="opn-lock-statusicons">
          <svg width="17" height="12" viewBox="0 0 17 12" fill="currentColor">
            ...
            <rect x="13.5" y="0" width="3" height="12" rx="0.5" opacity="0.5" />
          </svg>
          <svg width="16" height="12" viewBox="0 0 16 12" fill="currentColor">
            <path d="M8 2.4C10.5 2.4 12.7 3.5 14.2 5.2L15.8 3.4C13.8 1.3 11 0 8 0 5 0 2.2 1.3.2 3.4l1.6 1.8C3.3 3.5 5.5 2.4 8 2.4z" opacity="0.5" />
          ...
          <svg width="26" height="13" viewBox="0 0 26 13" fill="currentColor">
            <rect x="0.5" y="0.5" width="21" height="12" rx="2.5" stroke="currentColor" strokeWidth="1" fill="none" opacity="0.6" />
            <rect x="1.5" y="1.5" width="19" height="10" rx="2" opacity="0.95" />
            <path d="M23 4.5v4a2 2 0 000-4z" opacity="0.6" />
          </svg>
        </div>
      </div>
